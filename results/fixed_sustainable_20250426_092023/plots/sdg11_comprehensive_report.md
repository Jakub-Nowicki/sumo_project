...
### Traffic Efficiency
- Insufficient data to calculate waiting time statistics

### Environmental Impact
- Insufficient data to calculate emission statistics

### Intersection Throughput
- Insufficient data to calculate throughput statistics
